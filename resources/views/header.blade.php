...
<!-- Meta Description -->
    ...
    <style>
        ...
        .header-wrapper .logo img {
            width: 150px;
            filter: invert(14%) sepia(60%) saturate(5664%) hue-rotate(155deg) brightness(93%) contrast(101%);
        }
        ...
        .form-group.form-right .form-right-wrapper {
            display: flex;
            justify-content: space-between;
        }

        .form-group.form-right select {
            width: 27%;
            padding: 0 10px;
            border: none;
        }
        ...
        @media only screen and (max-width: 480px) {
            ...
            .header-right .top-menu:nth-child(2n) {
        ...
        <div class="header-wrapper">
            <div class="header-left">
                <h3 title="Sinh viên tìm nhà trọ">
                    <a class="logo" title="phongtrosinhvien.com" href="{{url('/')}}">
                        <img class="lazyload" data-src="{{asset('/imgs/logo-light.svg')}}"/>
                    </a>
                </h3>
            </div>
            <div class="header-right">
                <a class="top-menu" href="{{url('/')}}" title="Nhà trọ sinh viên">Tin Phòng trọ</a>
        ...
        <div class="row search-form">
            ...
            <div class="col-xs-12 col-sm-6 col-md-7 form-group form-right">
                <div class="full-width form-right-wrapper">
                    <?php $region_array = array('ha-noi' => 'Hà Nội', 'tp-ho-chi-minh' => 'Tp Hồ Chí Minh', 'đa-nang' => 'Đà Nẵng');?>
